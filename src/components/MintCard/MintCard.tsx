...
import { useAccount, useConnect, useContractRead, useContractWrite, useNetwork, usePrepareContractWrite, useWaitForTransaction } from "wagmi";
    ...
    <div className="min-w-[350px] min-h-full rounded-xl bg-primary border-black flex flex-col border border-tertiary shadow-lg">
      ...
      <div className="h-16 py-2 flex items-center justify-between px-5">
        ...
        <div className="flex flex-col">
          ...
          <p className="font-primaryBold text-tertiary">{`${ethers.utils.formatEther(mintPrice ? mintPrice : 0 )} ETH`}</p>
        </div>
      </div>
      <div>
